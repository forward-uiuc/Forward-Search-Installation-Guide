...
This contains step-by-step guide to set up Forward Search for a particular domain. Input is a URL template for the target domain and output is a web-based entity-semantic search engine for the domain. To understand the logic of each step below, please refer to Long Pham's master thesis at UIUC: https://github.com/forward-uiuc/Forward-Search-Installation-Guide/blob/master/PHAM-THESIS-2018.pdf
